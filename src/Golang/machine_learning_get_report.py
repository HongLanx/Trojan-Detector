...
def output_machine_learning_matching_report(folder=None):
    ...
    enc_report = predict_with_model("model/encryption_model.pkl",analyse_project_info, ssa_patterns_fin.encryption_patterns)
    bot_report = predict_with_model("model/botnet_model.pkl",analyse_project_info, ssa_patterns_fin.botnet_patterns)
    phish_report = predict_with_model("model/phishing_model.pkl",analyse_project_info, ssa_patterns_fin.phishing_patterns)
    obfuscate_report = predict_with_model("model/obfuscation_model.pkl",analyse_project_info, ssa_patterns_fin.obfuscation_patterns)
    penetrate_report = predict_with_model("model/penetration_model.pkl",analyse_project_info, ssa_patterns_fin.penetration_patterns)
    kernel_report = predict_with_model("model/kernel_model.pkl",analyse_project_info, ssa_patterns_fin.kernel_patterns)
    bypass_report = predict_with_model("model/bypass_model.pkl",analyse_project_info, ssa_patterns_fin.Defense_Bypass_patterns)
    ransom_report = predict_with_model("model/ransome_model.pkl",analyse_project_info, ssa_patterns_fin.ransomware_patterns)
